...
export const Emprunt = ({ getUser, getDocuments }) => {
    ...
    const getInput = () => {
        switch (rechercheType) {
            ...
            case 2:
                ...
                onChange={(e) => { setRecherche(e.target.value) }}></input>
            case 3:
                return <select className='form-select' onChange={(e) => { setRecherche(e.target.value) }}>
                    <option selected value={"roman"}>Roman</option>
        ...
        <>
            ...
            <div className='container'>
                ...
                <div className='input-group'>
                    {getInput()}
                    <button className='btn btn-outline-secondary' onClick={getDocuments(recherche,rechercheType)}>
